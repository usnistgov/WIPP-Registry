# WIPP Registry 2.x Installation Process
...
* These instructions support the manual installation process for WIPP Registry software version 2.x (located at https://github.com/usnistgov/WIPP-Registry ).
...
security:
   authorization: enabled
storage:
   dbPath: c:/nmrr/WIPP-Registry-wipp-registry/data/db
```
